...
```text
rx DATA via=2 temp=...cC humidity=...c% alarm=false gateway_time=...
...
```text
rx ALARM via=2 temp=...cC humidity=...c% alarm=true gateway_time=...
...
```text
rx DATA from sensor=3 temp=...cC humidity=...c% -> ack_bytes=... buffered_for_relay_slot=true
...
tx DATA seq=... parent=Some(2) temp=...cC humidity=...c% gateway_time=... bytes=...
